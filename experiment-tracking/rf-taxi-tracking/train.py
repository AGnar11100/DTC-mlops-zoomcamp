...
def run_train(
    wandb_project: 'rf-taxi-tracking',
    wandb_entity: 'naranneuron',
    data_artifact: 'naranneuron/rf-taxi-trips/NYC-Taxi:v0',
    max_depth: int,
    random_state: int,
):
    ...
    artifact = wandb.Artifact(f'taxi-rf-model', type='model')
